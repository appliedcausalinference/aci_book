...
::: {#fig-treatmentpretest5095 layout-ncol=2}

![Coefficients of treatment alone](img/Treatment5095.png)

![Coefficients of treatment when including pre-test scores](img/TreatmentPlusPretTest5095.png)

Post Scores with just treatment (left) and treatment plus pre-test scores (right) with 50 and 95 percent uncertainty intervals.
:::
