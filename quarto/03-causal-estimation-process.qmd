...
![Flow without conditioning](img/chain-flow.png)

![Flow with conditioning](img/chain-blocked.png)

Association flow in immoralities without conditioning and with conditioning
:::
...
::: {#fig-forks layout-ncol=2}

![Flow without conditioning](img/fork-flow.png)

![Flow with conditioning](img/fork-blocked.png)

Association flow in forks without conditioning and with conditioning
:::
...
::: {#fig-immorality layout-ncol=2}

![Flow without conditioning](img/immorality.png)

![Flow with conditioning](img/immorality-cond.png){height=80%}

Association flow in forks without and with conditioning
:::
