...
::: {#fig-trueandpc layout-ncol=2}

![True causal diagram](img/Sachs-truecausal.png)

![Causal structure learned by the PC algorithm](img/Sachs-pc.png)

True Structure vs. PC Algorithm Structure
:::
...
::: {#fig-trueandfci layout-ncol=2}

![True causal diagram](img/Sachs-truecausal.png)

![Causal structure learned by the FCI algorithm](img/Sachs-fci.png)

True Structure vs. FCI Algorithm Structure
:::
...
::: {#fig-trueandges layout-ncol=2}

![True causal diagram](img/Sachs-truecausal.png)

![Causal structure learned by the GES algorithm](img/Sachs-ges.png)

True Structure vs. GES Algorithm Structure
:::
...
::: {#fig-trueandlingam layout-ncol=2}

![True causal diagram](img/Sachs-truecausal.png)

![Causal structure learned by the LiNGAM algorithm](img/Sachs-lingam.png)

True Structure vs. LiNGAM Algorithm Structure
:::
