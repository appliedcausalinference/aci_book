...
```{r fig-neurips-causal, fig.cap="Causal papers featured at NeurIPS", fig.align='center', echo=FALSE, out.width='75%'}
...
```{r fig-commoncause, fig.cap="A plot of a hypothetical dataset of shark attacks and ice cream sales", fig.align='center', echo=FALSE, out.width='75%'}
...
```{r fig-spurious, fig.cap="An example of a spurious correlation", fig.align='center', echo=FALSE}
...
```{r fig-simpson1, echo=FALSE, fig.cap="Plot of high-level admission rates by gender", fig.align='center', message=FALSE}
...
```{r fig-simpson2, echo=FALSE, fig.cap="Reversal of trend when controlling for major", fig.align='center', message=FALSE}
...
```{r fig-simpson3, fig.cap='Admission rates and gender distribution by major', fig.align='center', echo=FALSE}
