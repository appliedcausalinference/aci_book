...
>Thus, according to the Markov assumption, If the variables are d-separated in the graphical model $G$, they are statistically independent in the observed data distribution $P$.
 ...
 $$ X \ind_{G} Y |Z \implies X \ind_{P} Y | Z $$
...
$$ X \ind_{G} Y |Z 	\Longleftarrow X \ind_{P} Y | Z$$
...
Let us consider an example with a known causal structure and then follow the steps of the PC algorithm to uncover the same structure. Fig.\@ref(fig:pc) shows the original causal graph and the steps followed in the PC algorithm. 

```{r pc, fig.cap='PC algorithms and steps', out.width="90%", echo=FALSE, fig.align='center'}
...
$$Y := f(X) + U$$
where $f(X)$ is a linear function, $X \ind U$ and $U$ is the unobserved non-Gaussian random distribution[@shimizu2006linear]. 
...
$$\forall_i\ X_i := g(f(pa_i) +U_i). \ X\ind U$$
...
We will compare different algorithms with the true causal graphs to understand the relative merits of each.
...
```{r trueandpc, fig.show = "hold", out.width='40%',fig.cap='True Structure vs. PC Algorithm Structure', echo=FALSE,fig.align='center'}
knitr::include_graphics('img/Sachs-truecausal.png')
knitr::include_graphics('img/Sachs-pc.png')
```
...
Upon comparing the true causal graph with the one generated by the FCI algorithm, as shown in Fig.\@ref(fig:trueandfci), several noteworthy observations can be made:
...
```{r trueandfci, fig.show = "hold", out.width='40%',fig.cap='True Structure vs. FCI Algorithm Structure', echo=FALSE,fig.align='center'}
knitr::include_graphics('img/Sachs-truecausal.png')
knitr::include_graphics('img/Sachs-fci.png')
```

#### GES Algorithm 

Upon comparing the true causal graph with the one generated by the GES algorithm, as shown in Fig.\@ref(fig:trueandges), several noteworthy observations can be made:
...
```{r trueandges, fig.show = "hold", out.width='40%',fig.cap='True Structure vs. GES Algorithm Structure', echo=FALSE,fig.align='center'}
knitr::include_graphics('img/Sachs-truecausal.png')
knitr::include_graphics('img/Sachs-ges.png')
```

#### LiNGAM Algorithm 

Comparing the true causal graph with the one generated by the LiNGAM algorithm, as shown in Fig.\@ref(fig:trueandlingam), several interesting observations can be made:
...
```{r trueandlingam, fig.show = "hold", out.width='40%',fig.cap='True Structure vs. LiNGAM Algorithm Structure', echo=FALSE,fig.align='center'}
knitr::include_graphics('img/Sachs-truecausal.png')
knitr::include_graphics('img/Sachs-lingam.png')
```
